            ...
            <div class="main">
                ...
                <main class="content px-3 py-4">
                    <div class="container-fluid">
                        <h3 style="color:#0C3B2E; font-weight:700;">Admin Dashboard</h3>
                        <section class="content">
                            <div class="row">
                                ...
                                <div class="box d-flex">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12" style="margin-right: 10px;"><br>
                                        <div class="info-box">
                                            <a href="../staff/staff.php"><span class="info-box-icon bg-aqua"style="color:#6D9773;margin-top:15px;"><i class="fa fa-users"></i></span></a>

                                            <div class="info-box-content">
                                                <span class="info-box-text">Total Staffs</span>
                                                <span class="info-box-number">
                                                    <?php
                                                    $q = mysqli_query($conn, "SELECT * from staff_tb");
                                                    $num_rows = mysqli_num_rows($q);
                                                    echo $num_rows;
                                                    ?>
                                                </span>
